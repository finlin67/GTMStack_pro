...
export default function VideoMarketingAnalyticsTile() {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center bg-background-dark font-display text-white selection:bg-primary/30">
      {/* Responsive Container: w-full h-full max 600px */}
      <div className="w-full max-w-[600px] h-full max-h-[600px] overflow-hidden relative bg-background-dark flex flex-col items-center p-6 gap-6 shadow-2xl rounded-xl ring-1 ring-white/5">
        ...
        >
            ...
            <div className="flex -space-x-2">
              <div className="size-6 rounded-full border border-background-dark overflow-hidden relative">
                <Image
